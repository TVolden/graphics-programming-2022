    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void main()
            {
                ...
                float i = round(GetColorLuminance(lighting) * _Levels) / _Levels;

                gl_FragColor = vec4(albedo * i * _LightColor0.rgb, 1.0f);
            }
            #endif // FRAGMENT
        ...
        Pass
        {
            ...
            void main()
            {
                ...
                gl_Position = unity_MatrixVP * vec4(worldPos + normal * 0.01f, 1.0f);
            }
            #endif // VERTEX
